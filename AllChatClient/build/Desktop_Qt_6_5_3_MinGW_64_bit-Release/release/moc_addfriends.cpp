...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAddFriendsENDCLASS_t qt_meta_stringdata_CLASSAddFriendsENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 18),  // "send_slelectByName"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 8),  // "username"
        QT_MOC_LITERAL(40, 8),  // "sendData"
        QT_MOC_LITERAL(49, 2),  // "id"
        QT_MOC_LITERAL(52, 14)   // "slelect_byName"
    },
    "AddFriends",
    "send_slelectByName",
    "",
...
void AddFriends::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->send_slelectByName((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->sendData((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->slelect_byName(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AddFriends::send_slelectByName; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AddFriends::*)(const QString & );
            if (_t _q_method = &AddFriends::sendData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AddFriends::send_slelectByName(const QString & _t1)
{
...
// SIGNAL 1
void AddFriends::sendData(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
